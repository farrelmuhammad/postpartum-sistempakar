...
const Ujian = () => {
    ...
    function submitHandler () {
        ...
        categories.forEach(category => {
            ...
            const newCfs = [...certaintyFactors, {categoryId: category.id, cf: cf}]
            setCertaintyFactors(newCfs)
        })
        ...
        return (
            <>
                ...
                { certaintyFactors.length > 0 && (
                    <div>
                        <h1>Hasil</h1>
                        <p>Nilai kepastian A: { certaintyFactors[0] }</p>
                        <p>Nilai kepastian B: { certaintyFactors[1] }</p>
                    </div>
                ) }
            </>
        )
