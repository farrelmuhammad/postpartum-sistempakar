                ...
                <div className="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                    <div className="right mx-lg-0 mx-auto">
                        ...
                        <form action="" method="post">
                            <div>
                                <label for="" className="d-block input-label">Email Address</label>
                                <div className="d-flex w-100 div-input">
                                    ...
                                    <input className="input-field border-0" type="email" name="" id="" placeholder="Your Email Address"
                                        autocomplete="on" required />
                                </div>
                            </div>
                            <div>
                                <label for="" className="d-block input-label">Password</label>
                                <div className="d-flex w-100 div-input">
                                    <svg className="icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <input className="input-field border-0" type="password" name="" id="password-content-3-5"
                            ...
                            <div className="d-flex mt-1 justify-content-end">
                                <a href="#" className="forgot-password fst-italic">Lupa Password?</a>
                            </div>
                            <button className="btn btn-fill text-white d-block w-100" type="submit">
